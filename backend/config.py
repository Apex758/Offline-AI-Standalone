...
IMAGE_MODEL_REGISTRY = {
    ...
    # ── Downloadable models ───────────────────────────────────────────────────
    "z-image-turbo-q4": {
        "folder":      "z-image-turbo-gguf",
        "backend":     "sd_cpp_zimage",
        "gguf_file":   "z_image_turbo-Q4_0.gguf",
        "description": "Z-Image Turbo Q4 — excellent quality, 8-step DiT",
        "steps":       8,
        "guidance":    1.0,
        "default_width":  512,
        "default_height": 1024,
        ...
        "download_label":   "Z-Image Turbo (8-step, Q4)",
        "download_files": [
            {"hf_repo": "leejet/Z-Image-Turbo-GGUF",                     "filename": "z_image_turbo-Q4_0.gguf"},
            {"hf_repo": "unsloth/Qwen3-4B-Instruct-2507-GGUF",           "filename": "Qwen3-4B-Instruct-2507-Q4_K_M.gguf"},
            {"hf_repo": "second-state/FLUX.1-schnell-GGUF",              "filename": "ae.safetensors"},
        ],
        "extra_files": {
    ...
    "flux2-klein-4b-q4": {
        ...
        "description": "FLUX.2 Klein 4B Q4 — fast 4-step, great quality",
        "steps":       4,
        "guidance":    1.0,
        "default_width":  512,
        "default_height": 512,
        ...
        "vram_required_mb": 0,
        "downloadable":     True,
        "download_size_gb": 5.3,
        "download_label":   "FLUX.2 Klein 4B (4-step, Q4)",
        "download_files": [
            {"hf_repo": "leejet/FLUX.2-klein-4B-GGUF",                   "filename": "flux-2-klein-4b-Q4_0.gguf"},
            {"hf_repo": "unsloth/Qwen3-4B-Instruct-2507-GGUF",           "filename": "Qwen3-4B-Instruct-2507-Q4_K_M.gguf"},
...
DEFAULT_TIER_CONFIG = {
    ...
    "tier4_diffusion_models": ["flux-schnell", "sd35-medium-q5", "z-image-turbo-q4", "flux2-klein-4b-q4"],
    "dual_model": {
        "enabled": False,
        "fast_model": None,
        "task_routing": {
