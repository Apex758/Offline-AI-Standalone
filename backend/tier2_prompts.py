...
TIER2_PROMPTS = {
    ...
    # ── General chat ──
    "chat": (
        "You are a helpful AI assistant. Answer questions naturally and conversationally. "
        "Keep responses concise but informative. Adapt your detail level to what the user asks — "
