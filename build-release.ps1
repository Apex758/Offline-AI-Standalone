Write-Host "=== Building OECS Teacher Assistant (Complete Build) ===" -ForegroundColor Cyan
...
if ($installer) {
    Copy-Item $installer.FullName "$releaseDir\OECS-Teacher-Assistant-Setup.exe"
...
# Create README
$readmeText = "OECS TEACHER ASSISTANT - INSTALLATION`n`n"
$readmeText += "FILES:`n"
$readmeText += "1. OECS-Teacher-Assistant-Setup.exe (includes all models)`n"
