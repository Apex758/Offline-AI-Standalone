...
$modelFile = "backend-bundle\llama-3.2-1b-instruct-Q5_K_M.gguf"
...
# Copy model file
Copy-Item $modelFile "$releaseDir\llama-3.2-1b-instruct-Q5_K_M.gguf"
...
2. llama-3.2-1b-instruct-Q5_K_M.gguf    (AI Model ~900 MB)
...
2. The file should be named: llama-3.2-1b-instruct-Q5_K_M.gguf
