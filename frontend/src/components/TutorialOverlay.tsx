...
export const getDashboardWalkthroughSteps = (t: (key: string) => string): TutorialStep[] => [
  ...
  {
    target: '[data-tutorial="fab-main"]',
    title: t('tutorial.dashboard.step19.title'),
    description: t('tutorial.dashboard.step19.description'),
    position: 'left',
    interactive: true,
    waitForAction: 'click',
    actionHint: t('tutorial.dashboard.step19.actionHint'),
  },
  {
    target: '[data-tutorial="fab-search"]',
    title: t('tutorial.dashboard.step20.title'),
    description: t('tutorial.dashboard.step20.description'),
    position: 'left',
  },
  {
    target: '[data-tutorial="fab-display"]',
    title: t('tutorial.dashboard.step21.title'),
    description: t('tutorial.dashboard.step21.description'),
    position: 'left',
  },
  {
    target: '[data-tutorial="fab-screenshot"]',
    title: t('tutorial.dashboard.step22.title'),
    description: t('tutorial.dashboard.step22.description'),
    position: 'left',
  },
  {
    target: '[data-tutorial="fab-sticky"]',
    title: t('tutorial.dashboard.step23.title'),
    description: t('tutorial.dashboard.step23.description'),
    position: 'left',
  },
  {
    target: '[data-tutorial="fab-tutorial"]',
    title: t('tutorial.dashboard.step24.title'),
    description: t('tutorial.dashboard.step24.description'),
    position: 'left',
  },
  {
    target: '[data-tutorial="fab-main"]',
    title: t('tutorial.dashboard.step25.title'),
    description: t('tutorial.dashboard.step25.description'),
    position: 'left',
    interactive: true,
    waitForAction: 'click',
    actionHint: t('tutorial.dashboard.step25.actionHint'),
  },
];