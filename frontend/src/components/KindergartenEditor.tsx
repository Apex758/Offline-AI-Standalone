  ...
  return (
    <div className="rounded-lg max-w-5xl mx-auto widget-glass">
      ...
      <div className="border-b border-gray-200 p-6 bg-gradient-to-r from-cyan-50 to-blue-50">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">{t('planEditors.editKindergarten')}</h2>
        
        {/* Metadata Editing */}
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('planEditors.lessonTopic')}</label>
            <SmartInput
              value={plan.metadata.title}
              onChange={(val) => updateMetadata('title', val)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500"
              placeholder={t('planEditors.enterLessonTopic')}
            />
          </div>
          <div>
        ...
        <div className="mt-4">
          <label className="block text-sm font-medium text-gray-700 mb-2">{t('planEditors.developmentalDomains')}</label>
