          ...
          <div key={i} style={{
            ...
            <div style={{
              ...
              {loading
                ...
                : <span style={{ fontSize: 13, color: 'var(--text-heading)', lineHeight: 1.4, fontWeight: 500 }}>{displayColumnA[i] || ''}</span>
              }
            ...
            <div style={{
              ...
              {loading
                ? <ShimmerBar variant="paper" accentColor={ACCENT} style={{ height: 13, flex: 1 }} />
                : <span style={{ fontSize: 13, color: 'var(--text-heading)', lineHeight: 1.4, fontWeight: 500 }}>{shuffledB[i] || ''}</span>
              }
            </div>
          </div>
        ))}
