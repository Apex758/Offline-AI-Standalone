...
const GRADE_SUBJECT_FILES: Record<string, () => Promise<any>> = {
  ...
  '1-Language Arts': () => import('./curriculum/grade1-language-arts.json'),
  '1-Mathematics': () => import('./curriculum/grade1-mathematics.json'),
  '1-Science': () => import('./curriculum/grade1-science.json'),
  '1-Social Studies': () => import('./curriculum/grade1-social-studies.json'),
  '2-Language Arts': () => import('./curriculum/grade2-language-arts.json'),
  '2-Mathematics': () => import('./curriculum/grade2-mathematics.json'),
  '2-Science': () => import('./curriculum/grade2-science.json'),
  '2-Social Studies': () => import('./curriculum/grade2-social-studies.json'),
  '3-Language Arts': () => import('./curriculum/grade3-language-arts.json'),
  '3-Mathematics': () => import('./curriculum/grade3-mathematics.json'),
  '3-Science': () => import('./curriculum/grade3-science.json'),
  '3-Social Studies': () => import('./curriculum/grade3-social-studies.json'),
  '4-Language Arts': () => import('./curriculum/grade4-language-arts.json'),
  '4-Mathematics': () => import('./curriculum/grade4-mathematics.json'),
  '4-Science': () => import('./curriculum/grade4-science.json'),
  '4-Social Studies': () => import('./curriculum/grade4-social-studies.json'),
  '5-Language Arts': () => import('./curriculum/grade5-language-arts.json'),
  '5-Mathematics': () => import('./curriculum/grade5-mathematics.json'),
  '5-Science': () => import('./curriculum/grade5-science.json'),
  '5-Social Studies': () => import('./curriculum/grade5-social-studies.json'),
  '6-Language Arts': () => import('./curriculum/grade6-language-arts.json'),
  '6-Mathematics': () => import('./curriculum/grade6-mathematics.json'),
  '6-Science': () => import('./curriculum/grade6-science.json'),
  '6-Social Studies': () => import('./curriculum/grade6-social-studies.json'),
};
