    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="overflow-hidden">
          ...
          <CardContent>
            <div className="h-48 relative mb-4">
              <img loading="lazy" src="./number-sense-g3.png" alt="Children learning number sense concepts" className="w-full h-full object-cover" />
            </div>
            <p className="text-sm">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent>
            <div className="h-48 relative mb-4">
              <img loading="lazy" src="./operations-w-numbers-g3.png" alt="Children learning multiplication" className="w-full h-full object-cover" />
            </div>
            <p className="text-sm">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent>
            <div className="h-48 relative mb-4">
              <img loading="lazy" src="./geometrical-thinking-g3.png" alt="Children learning about geometric shapes" className="w-full h-full object-cover" />
            </div>
            <p className="text-sm">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent>
            <div className="h-48 relative mb-4">
              <img loading="lazy" src="./measurement-g3.png" alt="Children measuring objects" className="w-full h-full object-cover" />
            </div>
            <p className="text-sm">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent>
            <div className="h-48 relative mb-4">
              <img loading="lazy" src="./data-probability-g3.png" alt="Children creating graphs and charts" className="w-full h-full object-cover" />
            </div>
            <p className="text-sm">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent>
            <div className="h-48 relative mb-4">
              <img loading="lazy" src="./cross-strand-g3.png" alt="Children working on mathematics projects" className="w-full h-full object-cover" />
            </div>
            <p className="text-sm">
