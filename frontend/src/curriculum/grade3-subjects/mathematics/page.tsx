  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="w-full min-w-full max-w-[100vw] mb-8">
        <div className="bg-gradient-to-r from-teal-100 to-blue-100 p-6 rounded-xl shadow-md">
          ...
          <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
            ...
            making informed decisions. The Grade 3 curriculum builds upon foundational concepts and introduces new
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-teal-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              In Grade 3, students develop a deeper understanding of numbers up to 10,000, including place value,
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-blue-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Students build fluency with addition and subtraction within 1000, using various strategies including place
              value and properties of operations. They develop understanding of multiplication and division within 100,
              using arrays, equal groups, and properties of operations.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-amber-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Grade 3 students identify, describe, extend, and create a variety of patterns, including those found in
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-pink-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              In Grade 3, students learn to measure length, mass, capacity, and area using standard units. They tell and
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-indigo-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              ...
              interpret data to answer questions and make decisions. Grade 3 students also explore probability concepts,
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Grade 3 Mathematics Overview</h2>
        <p className="mb-4 text-gray-700">
          The Grade 3 mathematics curriculum is designed to build upon the foundation established in Grade 2. It
