...
const Boxes: React.FC<{ className?: string; style?: React.CSSProperties }> = (p) => <Icon icon={Package01IconData} {...p} />;
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              ...
              <div className="relative w-full h-64 mb-6 rounded-md overflow-hidden">
                <img loading="lazy" src="./children-sorting-various-materials-and-objects-int.png" alt="Material Sorters Activity" className="w-full h-full object-cover" />
              </div>
