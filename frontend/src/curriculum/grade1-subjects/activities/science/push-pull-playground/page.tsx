          ...
          <Card className="mb-6">
            ...
            <CardContent>
              ...
              <div className="relative w-full h-64 mb-6 rounded-md overflow-hidden">
                <img loading="lazy" src="./children-playing-with-toy-cars-on-ramps-and-differ.png" alt="Push and Pull Playground Activity" className="w-full h-full object-cover" />
              </div>
