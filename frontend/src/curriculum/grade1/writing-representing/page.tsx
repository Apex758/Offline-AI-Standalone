...
import { ChevronLeft, PenTool, FileEdit, FileCheck } from "lucide-react"
...
export default function WritingRepresentingPage() {
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Writing and Representing</h1>
      ...
      <Tabs defaultValue="elo5" className="mb-8">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="elo5" className="flex items-center gap-2">
            <PenTool className="h-4 w-4" />
            ELO 5: Drafting
          </TabsTrigger>
          <TabsTrigger value="elo6" className="flex items-center gap-2">
            <FileEdit className="h-4 w-4" />
            ELO 6: Revising
          </TabsTrigger>
          <TabsTrigger value="elo7" className="flex items-center gap-2">
        ...
        <TabsContent value="elo5" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Essential Learning Outcome 5</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <h3 className="text-lg font-semibold mb-4">Grade Level Expectations</h3>

              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="pleasure">
                  <AccordionTrigger>Write for pleasure and personal growth</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="process">
                  <AccordionTrigger>Engage in the writing process</AccordionTrigger>
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                ...
                <AccordionItem value="language">
                  <AccordionTrigger>Explore language structures</AccordionTrigger>
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                ...
                <AccordionItem value="word">
                  <AccordionTrigger>Explore word solving</AccordionTrigger>
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
        ...
        <TabsContent value="elo6" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Essential Learning Outcome 6</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="organization">
                      <AccordionTrigger>Revise organization styles of drafted writing</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-1">
                          <li>
                    ...
                    <AccordionItem value="vocabulary">
                      <AccordionTrigger>Develop language use when revising (vocabulary)</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-1">
                          <li>
                    ...
                    <AccordionItem value="grammar">
                      <AccordionTrigger>Develop language use when revising (grammar)</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-1">
                          <li>
                    ...
                    <AccordionItem value="voice">
                      <AccordionTrigger>Develop language use when revising (voice)</AccordionTrigger>
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-1">
                ...
                <div>
                  ...
                  <h4 className="font-semibold mb-2 mt-4">Assessment Approaches</h4>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
        ...
        <TabsContent value="elo7" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Essential Learning Outcome 7</CardTitle>
              <CardDescription>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <h3 className="font-semibold mb-2">Writing Process Overview</h3>
            <p className="mb-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <strong>ELO 5:</strong> Brainstorming and Writing the First Draft - Think ideas out loud or draw them
                before writing.
              </li>
              <li>
                <strong>ELO 6:</strong> Revising - After completing the first draft, reread and perhaps share it before
                revising.
              </li>
              <li>
                <strong>ELO 7:</strong> Editing - Writing the final version using best efforts at spelling and visual
                presentation.
              </li>
            </ul>
          </div>
