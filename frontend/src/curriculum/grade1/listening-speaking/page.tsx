...
export default function ListeningSpeakingPage() {
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Listening and Speaking</h1>
      ...
      <Card className="mb-8">
        <CardHeader>
          <CardTitle>Essential Learning Outcome 1: Listening and Speaking</CardTitle>
          <CardDescription>
            The learner will explore, use, and critically apply oral language for pleasure, personal growth, to form and
            foster relationships and, to develop an appreciation of and celebration of culture and of oral languages.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <h3 className="text-lg font-semibold mb-4">Grade One Expectations for Listening and Speaking</h3>

          <Tabs defaultValue="personal">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="personal">For Pleasure & Personal Growth</TabsTrigger>
              <TabsTrigger value="relationships">For Relationships</TabsTrigger>
              <TabsTrigger value="culture">For Cultural Appreciation</TabsTrigger>
            </TabsList>

            <TabsContent value="personal" className="p-4 border rounded-md mt-2">
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Listen to a range of music, rhymes, poetry, stories, information, conversation and environmental
                  sounds for personal enjoyment
                </li>
                <li>
            ...
            <TabsContent value="relationships" className="p-4 border rounded-md mt-2">
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Listen respectfully to what other people are saying as they become aware of how to respond with
                  empathy and share with clarity
                </li>
            ...
            <TabsContent value="culture" className="p-4 border rounded-md mt-2">
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  Continue to develop and apply vocabulary and language structures to enhance communication of ideas
                  with purpose and focus for a range of audiences
                </li>
              </ul>
            </TabsContent>
          </Tabs>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          <CardHeader>
            <CardTitle>Specific Curriculum Outcomes</CardTitle>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Inclusive Assessment Strategies</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="mb-4">Assessment strategies that provide information about learning:</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Conversations:</strong> Anecdotal notes, class chats, learner interest inventory
                </li>
                <li>
                  <strong>Observations:</strong> During lessons and playtime to gather information about comfort level
                  with communication, friendships, language choices, and vocabulary use
                </li>
                <li>
                  <strong>Products:</strong> Questioning after listening activities, phonological awareness checklist,
                  quizzes
                </li>
              </ul>

              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold mb-2">Sample Assessment Tools:</h4>
