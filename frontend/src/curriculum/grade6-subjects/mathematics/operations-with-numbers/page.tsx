...
export default function Grade6MathematicsOperationsPage() {
  return (
    <div className="container mx-auto py-8">
      <Breadcrumb
        items={[
          ...
          { label: "Operations", href: "/curriculum/grade6-subjects/mathematics/operations" },
        ]}
      />
      ...
      <div className="w-full min-w-full max-w-[100vw] mb-8">
        <div className="bg-gradient-to-r from-teal-100 to-blue-100 p-6 rounded-xl shadow-md">
          ...
          <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
            Explore the Operations strand of the Grade 6 Mathematics curriculum. Develop skills in understanding and
            applying operations with numbers.
          </p>
        </div>
      </div>
      ...
      <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 mb-6">
        ...
        <Tabs defaultValue="additive-thinking">
          ...
          <TabsContent value="additive-thinking" className="p-4 border rounded-md mt-2 bg-indigo-50 border-indigo-200">
            <h4 className="font-semibold mb-2">Essential Learning Outcome 1: Additive Thinking</h4>
            <ul className="list-disc pl-5 space-y-2 mt-4">
              <li>Understanding the Meaning of Addition and Subtraction and how They Relate</li>
              <li>Compute Fluently Using Operations (+,-)</li>
              <li>Make a Reasonable Estimation When Using Operation</li>
            </ul>
          </TabsContent>
          ...
          >
            <h4 className="font-semibold mb-2">Essential Learning Outcome 2: Multiplicative Thinking</h4>
            <ul className="list-disc pl-5 space-y-2 mt-4">
              <li>Understanding the Meaning of Multiplication and Division and How They Relate</li>
              <li>Compute Fluently with Operations (x&divide;)</li>
              <li>Make Reasonable Estimation When Using the Operation (x&divide;)</li>
            </ul>
          </TabsContent>
        </Tabs>
      </div>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="border border-indigo-200 rounded-md mb-2">
                ...
                <AccordionContent className="bg-indigo-50 px-4 py-2 rounded-b-md">
                  <ul className="list-disc pl-5 space-y-2">
                    <li>Add decimals up to the thousandth place.</li>
                    <li>Subtract decimals up to the thousandth place.</li>
                    <li>
                      Use properties of operations and explain the inverse relationship between addition and
                      subtraction.
                    </li>
                  </ul>
                </AccordionContent>
              ...
              <AccordionItem value="item-2" className="border border-indigo-200 rounded-md mb-2">
                ...
                <AccordionContent className="bg-indigo-50 px-4 py-2 rounded-b-md">
                  <ul className="list-disc pl-5 space-y-2">
                    <li>multiply whole numbers by proper fractions, using appropriate tools and strategies</li>
                    <li>Divide whole numbers by proper fractions using appropriate tools and strategies</li>
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-violet-50 p-6 rounded-xl shadow-md border border-indigo-100 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Base ten blocks for decimal operations</li>
              <li>Fraction bars and circles for operations</li>
              <li>Algebra tiles for understanding operations</li>
              <li>Number lines for addition and subtraction</li>
              <li>Calculators for checking work</li>
              <li>Grid paper for organizing calculations</li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Interactive fraction operation tools</li>
              <li>Decimal operation simulators</li>
        ...
        <div className="mt-4">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>"Teaching Operations: Whole Numbers, Decimals, Fractions" by Susan O'Connell</li>
            <li>"Extending Children's Mathematics: Fractions and Decimals" by Susan Empson</li>
            <li>"Building Fluency with Math Operations" by Jennifer Bay-Williams</li>
          </ul>
        </div>
      </div>
