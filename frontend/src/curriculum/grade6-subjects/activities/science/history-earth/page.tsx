...
import FingerprintIconData from '@hugeicons/core-free-icons/FingerprintIcon';
...
const Fossil: React.FC<{ className?: string; style?: React.CSSProperties }> = (p) => <Icon icon={FingerprintIconData} {...p} />;
