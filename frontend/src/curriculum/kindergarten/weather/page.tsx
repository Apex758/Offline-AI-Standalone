...
import CloudFastWindIconData from '@hugeicons/core-free-icons/CloudFastWindIcon';
...
const Wind: React.FC<{ className?: string; style?: React.CSSProperties }> = (p) => <Icon icon={CloudFastWindIconData} {...p} />;
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="md:col-span-2">
          <img loading="lazy" src="./kindergarten-weather-exploration.png" alt="Kindergarten students exploring weather concepts" className="w-auto h-auto" />
        </div>
        <div>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mt-2">
                {[
                  {
                    week: "Week 1",
                    title: "Is the Weather Important?",
            ...
            <Card className="border-cyan-200 hover:border-cyan-300 hover:shadow-md transition-all">
              <CardHeader className="bg-cyan-50 border-b border-cyan-100 group-hover:bg-cyan-100 transition-all">
                <CardTitle className="text-cyan-700 flex items-center">
                  <CloudSun className="mr-2 h-5 w-5" /> Week 1: Is the Weather Important?
                </CardTitle>
