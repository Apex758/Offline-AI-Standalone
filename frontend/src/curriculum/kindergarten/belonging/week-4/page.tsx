        ...
        <div className="md:w-1/3">
          ...
          <div className="h-48 bg-gradient-to-r from-teal-400 to-cyan-400 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center p-2">
              ...
              <img loading="lazy" src="./kindergarten-community.png" alt="Children’s crayon drawings with the word “COMMUNITY,” showing police, doctor, firefighter, store, houses, and kids holding hands, highlighting helpers, places, and working together." className="w-full h-full object-cover" />
