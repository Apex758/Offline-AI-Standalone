      ...
      <div className="flex flex-col md:flex-row gap-6 mb-8">
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <Link href="/curriculum/kindergarten/belonging/week-4">
              <Button
                variant="outline"
                className="border-blue-300 text-blue-700 hover:bg-blue-50 flex items-center gap-2 bg-transparent"
              >
          ...
          <Card className="border-blue-200 shadow-md overflow-hidden">
            <div className="h-48 bg-gradient-to-r from-blue-400 to-indigo-400 relative">
              <div className="absolute inset-0 flex items-center justify-center p-2">
                <Image
                  src="/kindergarten-global-diversity.png"
                  alt="Children’s crayon drawings with the words “GLOBAL DIVERSITY,” showing kids of different ethnicities holding hands, a globe, and the words “WORLD” and “TOGETHER,” celebrating unity and diversity."
                  fill
