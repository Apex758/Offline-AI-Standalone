          ...
          <Card className="border-blue-200 shadow-md overflow-hidden">
            ...
            <div className="h-48 bg-gradient-to-r from-blue-400 to-indigo-400 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-2">
                ...
                <img loading="lazy" src="./kindergarten-global-diversity.png" alt="Children’s crayon drawings with the words “GLOBAL DIVERSITY,” showing kids of different ethnicities holding hands, a globe, and the words “WORLD” and “TOGETHER,” celebrating unity and diversity." className="w-full h-full object-cover" />
