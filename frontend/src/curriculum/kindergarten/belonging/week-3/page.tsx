          ...
          <Card className="border-green-200 shadow-md overflow-hidden">
            ...
            <div className="h-48 bg-gradient-to-r from-pink-400 to-purple-400 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-2">
                ...
                <img loading="lazy" src="./kindergarten-my-school.png" alt="Children’s crayon drawings around the words “WEEKLY FOCUS,” showing school scenes, classmates, teachers, rules, and friendship." className="w-full h-full object-cover" />
