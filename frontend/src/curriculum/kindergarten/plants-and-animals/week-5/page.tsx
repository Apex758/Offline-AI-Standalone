    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="md:col-span-2">
          ...
          <img loading="lazy" src="./kindergarten-environmental-stewardship.png" alt="Children’s crayon drawing with the words “HELP PLANET,” showing a girl pointing to a recycling symbol, a boy holding a flower, Earth, trees, rain, sun, and crossed-out symbols of pollution like cars, trash, and factories to illustrate how human activities affect the environment and ways to help." className="w-auto h-auto" />
