  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <img loading="lazy" src="./kindergarten-family-celebration.png" alt="Family celebration" className="w-auto h-auto" />
        <img loading="lazy" src="./kindergarten-cultural-celebration.png" alt="Cultural celebration" className="w-auto h-auto" />
      </div>
        ...
        <Card className="border-amber-200">
          ...
          <CardContent className="pt-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              <img loading="lazy" src="./kindergarten-family-celebration.png" alt="Family celebration" className="w-auto h-auto" />
              <img loading="lazy" src="./kindergarten-cultural-celebration.png" alt="Cultural celebration" className="w-auto h-auto" />
              <img loading="lazy" src="./kindergarten-community-celebration.png" alt="Community celebration" className="w-auto h-auto" />
              <img loading="lazy" src="./kindergarten-celebration-together.png" alt="Celebrating together" className="w-auto h-auto" />
            </div>
