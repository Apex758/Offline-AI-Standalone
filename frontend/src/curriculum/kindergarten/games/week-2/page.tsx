    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col md:flex-row gap-3 justify-start">
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/games/week-2/week-plan.pdf">
                <Download className="mr-2 h-4 w-4" /> Week Plan PDF
              </Link>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/games/week-2/materials">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/games/week-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="md:col-span-2">
          <Image
            src="/kindergarten-social-games.png"
            alt="Children’s crayon drawing with the words “SOCIAL GAMES,” showing kids playing together, a girl holding a ball, children holding hands, puzzle pieces, dice, and a globe, with words like “FAMILY,” “FRIENDS,” “TEAMWORK,” “COOPERATION,” and “CLASSMATES."
            width={800}
            height={500}
