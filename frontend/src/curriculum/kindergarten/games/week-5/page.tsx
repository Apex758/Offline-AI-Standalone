    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col md:flex-row gap-3 justify-start">
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/games/week-5/week-plan.pdf">
                <Download className="mr-2 h-4 w-4" /> Week Plan PDF
              </Link>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/games/week-5/materials">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="md:col-span-2">
          <Image
            src="/kindergarten-games-week5.png"
            alt="Children’s crayon drawing with the words “GAME PRACTICE,” showing kids with a soccer ball, children building a puzzle for teamwork, a trophy, and labels like “PERSEVERANCE,” “FOLLOW RULES,” “SPORTSMANSHIP,” “TEAMWORK,” and “HAVE FUN.”"
            width={800}
            height={500}
