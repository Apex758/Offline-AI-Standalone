...
import RepeatIconData from '@hugeicons/core-free-icons/RepeatIcon';
...
const Repeat: React.FC<{ className?: string; style?: React.CSSProperties }> = (p) => <Icon icon={RepeatIconData} {...p} />;
import { Breadcrumb } from "@/components/breadcrumb"

export default function Grade4MathematicsPage() {
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="w-full min-w-full max-w-[100vw] mb-8">
        <div className="bg-gradient-to-r from-teal-100 to-blue-100 p-6 rounded-xl shadow-md">
          ...
          <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
            ...
            making informed decisions. The Grade 4 curriculum builds upon previous concepts and introduces new
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-teal-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              In Grade 4, students develop a deeper understanding of numbers up to 10,000, including place value,
              comparing and ordering numbers, and working with fractions and decimals. They learn to recognize patterns
              in numbers and develop mental math strategies.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link to="/curriculum/grade4-subjects/mathematics/number-sense">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-blue-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Students build fluency with addition and subtraction within 10,000, using various strategies including
              place value and properties of operations. They develop understanding of multiplication and division with
              larger numbers, using arrays, equal groups, and properties of operations.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link to="/curriculum/grade4-subjects/mathematics/operations-with-numbers">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-amber-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Grade 4 students identify, describe, extend, and create a variety of patterns, including those found in
              real-life contexts. They develop algebraic thinking by exploring number relationships and solving problems
              with unknown quantities using equations.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link to="/curriculum/grade4-subjects/mathematics/patterns-relationships">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-purple-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Students analyze and classify two-dimensional shapes based on their properties, including sides and
              angles. They recognize, name, and build three-dimensional shapes, and develop spatial reasoning through
              various activities and explorations of symmetry and transformations.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link to="/curriculum/grade4-subjects/mathematics/geometrical-thinking">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-pink-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              In Grade 4, students learn to measure length, mass, capacity, and area using standard units. They tell and
              write time to the nearest minute, and solve problems involving money and elapsed time. Students also
              estimate measurements and make comparisons based on attributes.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link to="/curriculum/grade4-subjects/mathematics/measurement">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-indigo-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Students learn to collect, organize, and represent data using pictographs, bar graphs, and tables. They
              interpret data to answer questions and make decisions. Grade 4 students also explore probability concepts,
              conducting simple experiments and describing the likelihood of events.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link to="/curriculum/grade4-subjects/mathematics/data-probability">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Grade 4 Mathematics Overview</h2>
        <p className="mb-4 text-gray-700">
          The Grade 4 mathematics curriculum is designed to build upon the foundation established in Grade 3. It
      ...
      <div className="mt-8 flex justify-center">
        <Link to="/curriculum/grade4-subjects/activities/mathematics"><Button>
