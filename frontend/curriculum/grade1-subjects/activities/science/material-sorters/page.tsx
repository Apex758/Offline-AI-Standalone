  ...
  return (
    <div className="container mx-auto py-8">
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              ...
              <div className="relative w-full h-64 mb-6 rounded-md overflow-hidden">
                <Image src="/children-sorting-various-materials-and-objects-int.png" alt="Material Sorters Activity" fill className="object-cover" />
              </div>
      ...
      <div className="flex justify-center">
        <Link href="/curriculum/grade1-subjects/activities/science/plant-detectives">
