...
const socialStudiesStrands = [
  {
    ...
    description:
      "Explore the different ethnicities and cultures that make up Caribbean society and their contributions to our collective history.",
    ...
    activities: 7,
    difficulty: "Medium",
    tags: ["history", "culture", "heritage", "identity"],
  },
  {
    id: "spatial-thinking",
    title: "Spatial Thinking",
    description:
      "Discover geographic locations, water bodies, seasons, and natural hazards that shape our island environment.",
    ...
    activities: 6,
    difficulty: "Easy",
    tags: ["geography", "environment", "climate", "hazards"],
  },
  {
    id: "civic-participation",
    title: "Civic Participation",
    description:
      "Learn about national symbols, anthems, emblems, and heroes that help define our unique island identity.",
    ...
    activities: 5,
    difficulty: "Easy",
    tags: ["citizenship", "symbols", "heroes", "identity"],
  },
  {
    id: "economic-decision-making",
    title: "Economic Decision Making",
    description: "Understand how our natural and human resources shape our island identity and economy.",
    icon: <DollarSign className="h-10 w-10 text-amber-500" />,
    image: "/placeholder.svg?height=200&width=300&query=children+learning+about+economy+and+resources",
    color: "bg-amber-50 hover:bg-amber-100",
    borderColor: "border-amber-200",
    activities: 8,
    difficulty: "Medium",
    tags: ["economy", "resources", "culture", "population"],
  },
]

export default function Grade3SocialStudiesActivitiesPage() {
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
          Explore engaging activities designed to develop essential social studies skills through historical thinking,
          spatial awareness, civic participation, and economic understanding.
        </p>
      </div>
      ...
      >
        {filteredStrands.map((strand) => (
          <motion.div key={strand.id} variants={item}>
            <Link href={`/curriculum/grade3-subjects/activities/social-studies/${strand.id}`}>
              <Card
