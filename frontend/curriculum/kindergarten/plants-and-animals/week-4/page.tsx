    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col md:flex-row gap-3 justify-start">
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/plants-and-animals/week-4/week-plan.pdf">
                <Download className="mr-2 h-4 w-4" /> Week Plan PDF
              </Link>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/plants-and-animals/week-4/materials">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/plants-and-animals/week-3">
                <ChevronLeft className="mr-2 h-4 w-4" /> Previous Week
              </Link>
            </Button>
            <Button variant="outline" size="sm" asChild>
              <Link href="/curriculum/kindergarten/plants-and-animals/week-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="md:col-span-2">
          <Image
            src="/kindergarten-environments.png"
            alt="Children’s crayon drawing with the words “CHANGING ENVIRONMENTS,” showing a boy building a house, a beaver cutting a tree, a rabbit digging, an elephant near palm trees, plants growing, and symbols of sun, rain, and shelter to illustrate how living things change their environments."
            width={800}
            height={500}
